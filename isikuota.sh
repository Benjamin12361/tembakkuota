...
echo "\033[31;1m=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*"
echo ""
echo "Author : " •MRX•BENJAMIN"
" Team : " LIGHT CYBER INDONESIA"
echo " Kontak Me : " 089637888353"
" Pesan : "Jangan Di Salah Gunakan Dan Disebar :) Karena Nanti Dosa Tanggung Sendiri:)"
sleep 1
echo "ThanksTo:"
echo "Allmember LIGHT CYBER INDONESIA&MUSLIM CYBER ARMY"
echo "\033[33;1m=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*"
echo ""
sleep 2
...
sleep 2
echo "Thanks To:ALLAH SWT TEAM? LIGHT CYBER INDONESIA&MUSLIM CYBER INDONESIA"
sleep 2
